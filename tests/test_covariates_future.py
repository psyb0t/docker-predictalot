"""POST /v1/covariates/future/{forecast,forecast/ensemble}.

Member of TYPE_COVARIATES_FUTURE: chronos-2 only (in v0.2).
"""
...
URL = "/v1/timeseries/covariates/future/forecast"
ENSEMBLE_URL = "/v1/timeseries/covariates/future/forecast/ensemble"
...
class TestCovariatesFutureHappyPath:
...
class TestCovariatesFutureValidation:
...
class TestCovariatesFutureEnsemble:
    def test_single_member_ensemble_works(self, client: TestClient) -> None:
        """With only one supporting model the ensemble is degenerate but still valid."""
        ...
        assert "chronos-2" in out["individual"]
